...
תוסף Codex לחיבור WhatsApp דרך Green API, לתלמידי "עסק אטומי למתחילים".
...
אחרי הוספת ה-marketplace מתקינים שני תוספים מאותה חבילה:
- `whatsapp`
- `elevenlabs`

שניהם קוראים את אותו `.env` המקומי.
